...
import type { IApiResponse, IReadTracksMetadataBatchResponseData } from '@/app/shared/api/types'
...
import { MAX_AUDIO_FILE_SIZE, MAX_AUDIO_FILES_PER_BATCH } from '@/app/shared/constants'

export async function POST(
  request: NextRequest
): Promise<NextResponse<IApiResponse<IReadTracksMetadataBatchResponseData>>> {
  ...
  const tracks: IReadTracksMetadataBatchResponseData['tracks'] = []
  const errors: IReadTracksMetadataBatchResponseData['errors'] = []
